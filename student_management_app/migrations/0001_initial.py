# Generated by Django 3.1.1 on 2020-10-26 01:32
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text=models.CharField(verbose_name={'placeholder': 'surname in caps'}), max_length=40)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('subject2', models.CharField(choices=[('MATHEMATICS', 'MATHEMATICS'), ('PHYSICS', 'PHYSICS'), ('CHEMISTRY', 'CHEMISTRY'), ('LITERATURE', 'LITERATURE'), ('ENGLISH', 'ENGLISH'), ('GOVERNMENT', 'GOVERNMENT'), ('COMMERCE', 'COMMERCE'), ('ECONOMICS', 'ECONOMICS')], max_length=20)),
                ('subject3', models.CharField(choices=[('MATHEMATICS', 'MATHEMATICS'), ('PHYSICS', 'PHYSICS'), ('CHEMISTRY', 'CHEMISTRY'), ('LITERATURE', 'LITERATURE'), ('ENGLISH', 'ENGLISH'), ('GOVERNMENT', 'GOVERNMENT'), ('COMMERCE', 'COMMERCE'), ('ECONOMICS', 'ECONOMICS')], max_length=20)),
                ('subject4', models.CharField(choices=[('MATHEMATICS', 'MATHEMATICS'), ('PHYSICS', 'PHYSICS'), ('CHEMISTRY', 'CHEMISTRY'), ('LITERATURE', 'LITERATURE'), ('ENGLISH', 'ENGLISH'), ('GOVERNMENT', 'GOVERNMENT'), ('COMMERCE', 'COMMERCE'), ('ECONOMICS', 'ECONOMICS')], max_length=20)),
                ...
                ('end_time4', models.TimeField(help_text=models.CharField(verbose_name={'placeholder': 'name in caps'}))),
                ...
                ('subject1', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='student_management_app.subjects')),
            ],
        ),
        migrations.CreateModel(
            name='Students',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subject', models.ForeignKey(max_length=50, on_delete=django.db.models.deletion.CASCADE, to='student_management_app.subjects')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField()),
                ('learning', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='student_management_app.learning')),
                ('subject', models.ForeignKey(max_length=50, on_delete=django.db.models.deletion.CASCADE, to='student_management_app.subjects')),
            ],
        ),
        migrations.CreateModel(
