...
#from student_management_app.views import Create
from . import views
...
urlpatterns = [
    ...
    # URSL for Student
    path('student_home/', StudentViews.Student_home.as_view(), name="student_home"),
    ...
    path('timetable/', HodViews.timetableview, name='timetable'),
    path('tables/', views.Timetableview.as_view(), name='tables'),

    #FEE PAYMENT
    path('feepaymentform/', views.feepayment, name='feepaymentform'),
    path('payreceipt/', views.Payfeesview.as_view(), name='payreceipt'),
    path('paydetail/', views.paymentformdetail, name='paydetail'),
]
